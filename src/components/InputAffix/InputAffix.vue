<template>
  <div class="concrete__input-affix h-full relative inline-flex items-center text-inherit px-3 border border-inherit whitespace-nowrap bg-black bg-opacity-5"
