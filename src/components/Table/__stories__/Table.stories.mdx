...
export const componentTemplate = (args) => ({
  ...
  data() {
    const team = {
      1: { id: 1, name: 'lee', role: 'developer' },
      2: { id: 2, name: 'matt', role: 'developer' },
      3: { id: 3, name: 'dan', role: 'developer' },
      4: { id: 4, name: 'yaming', role: 'developer' },
      5: { id: 5, name: 'pete', role: 'developer' },
      6: { id: 6, name: 'calum', role: 'developer' },
      7: { id: 7, name: 'robi', role: 'developer' },
    };
    return { team };
  },
  methods: {
