<template>
  <div class="flex w-full">
    ...
    <input
      ...
      v-model="value"
      type="text"
      :class="['relative truncate z-20 w-full border text-left pl-3 pr-3 focus:outline-none focus:ring-1 focus:border-indigo-light focus:ring-indigo-light', sizeClass, colorClass, disabledClass, cursorClass, bgColor ]"
